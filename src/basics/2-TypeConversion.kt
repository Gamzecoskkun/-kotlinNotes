...
//--------------------------------------------------------------------------------------------------------------------
    ...
    /**
     *  1-Numbers.kt dosyasinin icerisiindeki degisken tiplerinin deger araliklarini inceleyiniz.
...
//--------------------------------------------------------------------------------------------------------------------
    ...
    /**
     * Numbers.kt icerindeki degisim tiplerinin deger araliklarini inceleyiniz.
     ...
     * negatif yonde fazla kucuk ise bu tip donusumu sirasinda yanlis deger atamlari yapilacaktir.
     */
...
//--------------------------------------------------------------------------------------------------------------------
    ...
    val dividedNumber=1_000_000_000_000
    val resultNumber= longNumber/dividedNumber //1000
//Buyuk olan neyse onun tipini verir.
...
//--------------------------------------------------------------------------------------------------------------------
     ...
     * Bunun icin ilgili tiplerin Java versiyonlarini kullanmalisiniz
     *
     ...
     * java.lang.Byte.parseULong(),java.lang.Double.parseDouble(),java.lang.Float.parseUFloat()
     */

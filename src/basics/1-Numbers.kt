...
fun main() {
     ...
     *  Int    |  32 bit        |  -2,147,483,648                      | 2,147,483,647(2^31-1)
...
//----------------------------------------------------------------------------------------------------------
    ...
    /**
     * Degiskene deger atamasi yapilirken maksimum performans alamk icin dogru degiskenin tipini kullanmak onemlidir.
...
//-----------------------------------------------------------------------------------------------------------------
     ...
     * Double   degiskenşer icin geleneksel gosterim desteklenir.
...
//-------------------------------------------------------------------------------------------------------------------
    ...
    /**
     * Number degisken tanimi yapilirken undercore "-" kullanilabilir
     */

    val oneMillion=1_000_000
    val creditCardNumber=1234_5678_9012_3456L
    val bytes=0b01000011_01101111_011001000_01100101_011011101_01111001
...
//-------------------------------------------------------------------------------------------------------------------
     ...
     * ==  opratoru degiskenlerin degerini karsilastirirken kullanilir.
     */

    val number:Int=-128//int
